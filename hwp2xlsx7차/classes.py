class Problem:
    ...
    def addsentence(self, eng_sentence, kor_sentence, gender=None):
        self.__sentences.append(Sentence(eng_sentence, kor_sentence, gender))
...
class Sentence:
    ...
    def get_sentence(self):
        return (self.__eng_sentence, self.__kor_sentence)
